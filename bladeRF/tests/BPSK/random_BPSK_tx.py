...
class random_BPSK_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "random_BPSK_tx")
        ...
        self.sweep_bandwidth = sweep_bandwidth = 200e3
        self.sps = sps = 4
...
def main(top_block_cls=random_BPSK_tx, options=None):
