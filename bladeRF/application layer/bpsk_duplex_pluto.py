...
def main(top_block_cls=bpsk_duplex_pluto, options=None):
    ...
    tb = top_block_cls(http_port=options.http_port, my_addr=options.my_addr, nickname=options.nickname, peer_addr=options.peer_addr, rx_freq=options.rx_freq, tx_freq=options.tx_freq, uri=options.uri)
